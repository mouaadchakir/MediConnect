...
<body>
    ...
    <div class="chat-header">
      <div class="user-info">
        ...
        <div class="user-details">
          <h1>{{ ucwords(strtolower($datadoctor['name'])) }} <span style="font-size: 14px;color: #aaa;">(Médecin)</span></h1>
          <span class="status">
      ...
      <div class="header-actions">
        <a href="{{ route('user.meassagelist') }}" 
  ...
  <script src="{{ asset('js/user/meassangeroom.js') }}"></script>
</body>
</html>