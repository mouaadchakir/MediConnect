  ...
  <div class="container">
    ...
    <main class="main-content">
      <div class="form-container">
        <h2>Prendre rendez-vous avec Dr. {{ $doctor->name }}</h2>
        <form action="{{ route('user.appointments.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input id="appointment_date" type="datetime-local" name="appointment_date" value="{{ old('appointment_date') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea id="reason" name="reason" rows="4" placeholder="Entrez une brève raison pour votre visite.">{{ old('reason') }}</textarea>
                @error('reason')
                    <span class="error-message">{{ $message }}</span>
                @enderror
            </div>
